...
<body>
            ...
            <div class="header-content">
                ...
                <nav class="main-nav">
                    <ul>
                        ...
                        <li><a href="index.php?page=addProgrammeForm" class="active">Add Programme</a></li>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <form action="index.php?page=addProgramme" method="post">
                ...
                <select id="levelId" name="levelId" required>
                    <?php foreach ($levels as $level): ?>
                        <option value="<?= (int) $level['LevelID'] ?>"><?= htmlspecialchars($level['LevelName']) ?></option>
                    <?php endforeach; ?>
                </select>
